...
<c:if test="page.pageNo>6">
	<c:set var="page.totalPage" scope="page" value="(${page.totalCount}/${page.pageSize}+(${page.pageNo}-6))"/>
</c:if>
<c:if test="page.pageNo<=6">
	<c:set var="page.totalPage" scope="page" value="(${page.totalCount}/${page.pageSize})"/>
</c:if>
