...
<div style="width: 100%;text-align: left;">当前位置：58房源管理 &gt; 出租房管理 </div>  



<form action="/rent58/allrentsearch/list" method="post" id="rentForm" >
					...
					<tbody class="rasent">
						<c:forEach items="${rentList}" var="list">
								...
								<td style=" width:12.5%; text-align:center"><input type="checkbox" name="ids" value="${list.id}" />
									<td style=" width:12.5%; text-align:center"><a href="http://${list.cityDir}.taofang.com/zufang/${list.id}-1.html" class="link"  target="_blank" >${list.id}</a></td>
									...
									<td style=" width:12.5%; text-align:center">
									 <a href="http://${list.cityDir}.taofang.com/zufang/${list.id}-1.html" class="cluetip" rel="#img${list.id}" target="_blank" >${list.title}</a> 
									...
									<td style=" width:12.5%; text-align:center" ><a href="javascript:deleteRent(${list.id})" >删除</a>&nbsp;</td>
