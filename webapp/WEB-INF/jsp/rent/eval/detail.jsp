...
<div style="width: 100%;text-align: left;">当前位置：租房评价列表</div> 

<form action="/rent/eval/evalList/${houseId}/${sourceId}" method="post" id="evaluationForm" style="margin-top:0px;margin-top:0px;">
	...
	function delAllEvaluation(houseId, sourceId) {
		...
		if(evaluationIds.length > 0) {
			...
			$.ajax({
				type : "GET",
				async : false,
				url : "/rent/eval/delEval/" + houseId + "/" + sourceId,
