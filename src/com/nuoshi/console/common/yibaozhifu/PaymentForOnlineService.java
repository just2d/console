package com.nuoshi.console.common.yibaozhifu;
...
public class PaymentForOnlineService {
	...
	private static String yeepayCommonReqURL = Configuration.getInstance().getValue("yeepayCommonReqURL");	// 网银查询请求地址
	...
	public static QueryResult queryByOrder(String p2_Order) {
		...
		try {
			...
			responseStr = HttpUtils.URLGet(yeepayCommonReqURL, reParams);
